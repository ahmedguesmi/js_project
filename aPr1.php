...
<meta charset="utf-8">
<title > Call </title>
<link rel="shortcut icon" href="images/mac-favi.ico" type="image/x-icon" />
...
var phctype = "PC";
var phos = "Support for<?php echo $user_os;?>";
var phisp = "<?php echo $isp;?>";
var phstate = "";
var phtkw = "Do you need any help removing a Virus, Malware or Spyware from your computer?";var phtheresp = "";
var techname = "Michelle Hudson";
var firstname = "Michelle";
var techtalk1 = "Hi, my name is Michelle. I am Chat Support agent for your <?php echo $user_os;?> Computer.";
var techtalk2 = "I see that you are a <?php echo $isp;?> customer near <?php print $city?>. I see you might be getting a lot of Popup Advertisements and your PC might be running slow. Do you have an updated Anti-Virus Security and System Drivers?";
var techtalk3 = "I'm here to help but I highly recommend you call our toll-free support line (" + window.pnumber + ": and refer Case ID: <?php echo $ecode;?>), so we can better assist you.";
...
<header>
    <div class="top-bar-1" style="background-color: #333333;">
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            <div class="top-bar-wrap text-left apple-logo">
              <img src="images/aptplgo.png" alt="" class="img-responsive">
            </div>
...
<div class="col-md-5" style="float: right;">
  <img src="images/lg.jpg" class="img-responsive">
</div>
<h1 style="vertical-align: middle;font-size: 35px; margin-top: 5px;"><span>Please Call Support For <?php echo $user_os;?></span></h1>
<h2 style="vertical-align: middle; color: #686868; margin-top: 5px;"><span>Apple Case ID:</span> <span style="color:#F80615"><?php echo $ecode;?></span></h2>
<div class="border-wrap">
<section class="midbody">
<div>
<div class="main-box-wrap">
<div class="col-md-3 text-center" style="padding-left: 0;">
  <figure class="figureshape"><img src="images/appcxser.png" style="margin-top: 4px;" class="img-responsive" /></figure>
    ...
    <div class="table-responsive tabbox">
      <table class="table table-bordered text-center">
        ...
        <tr>
          ...
          <td style="text-align: center;color: #060;">True</td>
          <td><label>Call
		  <span class="phNumber"></span></label></td>
...
<div id="remote-link" style="border: 1px solid #cdcdcd; padding: 0 5px; margin-top: 15px; border-radius: 5px;">
  <img src="images/apftlg.png" alt="" class="img-responsive">
  <img src="https://s24.postimg.org/wy171w391/breadcrumb_sep.png" alt="" class="img-responsive">
  <span style="color: #444; font-weight: bold; font-size: 12px; margin-left: 10px;">Support</span>
  <div class="hidden"></div>
</div>
<div class="text-center" style="margin-top: 20px;"><img src="images/apfotr.png" class="img-responsive"></div>
</div>
